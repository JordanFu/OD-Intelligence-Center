...
assert.match(html, /\.levels-content-grid\s*\{[^}]*align-items:\s*start/s, '桌面端三个内容面板必须保持自然高度并顶部对齐');
assert.match(html, /const LEVELS_DAILY_VISIBLE_LIMIT = 2;/, '每日追溯默认只展示最新两条');
