...
const topics = [
  {
    ...
    keywords: ['扁平', '中层', 'manager', 'player-coach', '小队', 'span', 'coordination', '层级', '组织'],
    stableJudgments: [
  ...
  },
  {
    ...
    keywords: ['岗位', '族群', '序列', 'job', 'family', 'career', 'title', '职级', '带宽', 'pay band', 'builder'],
    stableJudgments: [
...
function evidenceLevel(text) {
  ...
  if (/Reuters|Deloitte|McKinsey|BCG|Mercer|EY|Payscale|媒体|咨询/i.test(text)) return 'Context层强证据';
  return '线索层/待验证';
}
