...
const dir = process.argv[2]
  ...
  : path.resolve(root, 'specials/ai-org-talent-mechanism/2026-05-13');

const files = [
  ['00-overview.md', '00-overview.html', '四课题总览'],
  ['01-flat-organization.md', '01-flat-organization.html', '专题一：组织扁平化与中层减少'],
  ['02-talent-density.md', '02-talent-density.html', '专题二：高人才密度与复合型人才'],
  ['03-job-family-career-architecture.md', '03-job-family-career-architecture.html', '专题三：岗位族群序列建设'],
  ['04-promotion-system.md', '04-promotion-system.html', '专题四：未来晋升机制'],
];
...
<body>
  <main>
    <div class="toolbar">
      <a class="btn" href="./index.html">返回四课题总览</a>
      <a class="btn" href="../../../index.html">返回 OD 情报中心</a>
      <a class="btn primary" href="./${esc(markdownFile)}">查看 Markdown</a>
    </div>
