...
AFGE v OPM 已作为日报/周报 PDF 证据源入库，当前需要完成结构化精读后再进入结论层。
...
- `specials/ai-org-talent-mechanism/2026-08-26/00-overview.md:133`：诉状 PDF
- `specials/ai-org-talent-mechanism/2026-08-26/01-flat-organization.md:25`：诉状 PDF
- `specials/ai-org-talent-mechanism/2026-08-26/01-flat-organization.md:200`：诉状 PDF
- `specials/ai-org-talent-mechanism/2026-08-26/04-promotion-system.md:21`：诉状
- `specials/ai-org-talent-mechanism/2026-08-26/04-promotion-system.md:167`：AFGE 等诉 OPM 诉状
