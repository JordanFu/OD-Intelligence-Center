...
## [2026-09-25] ingest | 工作重设计的配套条件

- 新增知识比较页，连接当日信息卡与导读，更新index/catalog；7条新增、1条旧线、1条缺口，不把旧案例计作新增。
- 只将已读公开网页作为依据；调查与企业自述保留边界。公众号原文和招聘原文覆盖未完成。

## [2026-09-24] ingest | 组织变化与剩余工作

- 新增知识比较页，关联当日信息卡、应用导读及既有责任边界页；更新index/catalog。4条新增事实、1条机制弱信号、1条缺口，不凑数量。
- 公开项目设计、公司自述与调查结果均保留适用边界；未取得公众号原文、独立招聘样本或完整研究报告的部分保持覆盖未完成。
- 执行公开PDF自动扫描，保留存量下载与重试记录；扫描不代表精读，公开引用上下文不含敏感来源。

## [2026-09-23] ingest | 工作条件、服务交接与评价权限

- 新增知识比较页及信息卡、应用导读，更新index/catalog。4条新增、1条补读、1条招聘弱信号和1条缺口；缺口不凑数，日期冲突明确记录。
- 将健康研究、政务服务整合与外部评价转成工作设计问题，不把模型情景或公开原则当成实际成效。公众号原文覆盖未完成。
- 已执行公开PDF扫描，存量下载与重试状态保留；下载不等于精读。仅公开安全的引用上下文进入仓库。

## [2026-09-22] ingest | 能力、授权与隐形劳动

- 新增比较知识页、当日信息卡与应用导读，更新index/catalog；高价值材料连接既有员工价值与责任边界页。
- 4条新增、3条弱信号、1条缺口；招聘及政策倡议不升级为成效，公众号原文覆盖未完成。调查方法、自报边界与原文口径差异明确保留。
- PDF扫描80个公开来源：68个存量可用、12个待重试，不等于本日新增或已精读。未取得完整问卷，不用报告网页替代完整方法。

## [2026-09-21] ingest | 人才定价与学习机会

- 新增比较知识页及当日信息卡、应用导读；W38双版本周报仅追加周日晚间事件收尾，不改写既有统计和日流。
- 2条重点读分别为公开岗位配对复核和具名招聘意向；新增事实仅1条，观点保持L1。未取得公众号原文、预印本正文或实际录用结果，不包装为完成。
- PDF扫描80个公开来源，保留存量可用和下载重试状态；未新增PDF精读判断。更新index、catalog及公开安全的引用上下文。

## [2026-09-21] review | 本地知识库定期 Review

- 新增 `knowledge/wiki/local-knowledge-review-2026-09-21.md` 并登记到 index/catalog；健康度 82/100（warn）。
- 审计确认近期 7 张机制比较页均有中文判断、证据边界和行动问题；两份非标准地址 PDF 已连接结构化机制页，不是孤立原文。
- 当前主要债务为 73/90 张 PDF 模板卡、67/88 条 PDF catalog 记录粗分为 media、12/14/15 三种 retry 口径、3 组重复 summaryFile 和 24 个历史专题待重跑日期。
- 修复正式运行窗口前 fallback 被提前计入待重跑的问题；9 月 21 日在 18:00 前正确显示 scheduled。
- 一方目标 3,902 个且硬断链为 0；公开信息库根页、9 月 20 日页面与知识库根页均返回 200。

## [2026-09-20] ingest | 责任边界与W38信息库聚合

- 新增比较知识页与信息库双版本周报，更新index、catalog及首页周报入口。周报截至周日晨间，不声称覆盖尚未发生的全天信息。
- 当日官方正文、招聘接口、开发者原文和学术摘要按实际读取范围分级；未取得公众号原文或论文全文，不以摘要充当精读。
- PDF扫描80个来源，68个存量原文可用、12个下载待重试；不是今日新增68份，也不代表已读。无新增PDF原文用于本日判断。

## [2026-09-19] ingest | 岗位责任与证据

- 新增比较知识页，连接当日信息卡、应用导读和既有工作流、AI风险页；更新index与catalog。
- 公开正文及薪酬方法已核读；供应商活动视频、公众号原文和独立实施后效未取得，不将其包装成结论。
- 自动PDF扫描识别80个来源；下载状态属于存量可用与重试记录，不等于今日新增或精读。今日比较页以公开网页为依据，不补造PDF原文。

## [2026-09-18] ingest | 工作流与测量分母

- 新增一张比较知识页，连接今日信息卡、应用导读、员工价值与AI工作风险页；更新index和catalog。
- 公开网页相关正文与方法已核，注册报告未取得全文，不将发布稿或预测升级为效果证据。
- 自动PDF扫描识别80个来源，68个已有原文、12个待重试；这是存量可用状态，不是本日新增68份。未将下载等同精读，BCG候选本轮未独立核到正文而未入选信息卡。

## [2026-09-17] ingest | 员工价值与纠错权

- 新增比较知识页，连接本日8条有效材料与既有交接、AI工作风险知识；更新index与catalog。
- 公开技能库研究PDF已下载并检查文件格式；原链接无PDF扩展名，另行归档补足自动扫描遗漏。只核相关方法，不宣称全文精读或复现实验。
- 保留商业承诺、匿名案例与平台调查的边界；不改历史正文，不把弱信号升级为结论。

## [2026-09-16] ingest | 交接、决策与岗位维护

- 新增一张比较知识卡，关联既有岗位价格与AI工作风险页；更新index、catalog。
- 公司自述、预印本与方法建议分开，应用建议不写成已验证效果；招聘和未完整读取公告保留观察等级。
- PDF下载、相关章节阅读及全文精读分别记录，不改历史内容。
- 自动扫描识别79个PDF来源，其中68个已下载、11个待重试；另补入库本日Atria论文，其原文地址无PDF扩展名未被扫描器识别。已验证可下载的等价PDF地址，归档为可读文件名并连接本日结构化比较页；不宣称全文精读。

## [2026-09-15] ingest | 岗位价格与责任设计检查

- 新增一张比较知识页，连接薪酬比较方法、治理草案与论坛／招聘线索，所有应用建议与已验证效果分开。
- 更新index、catalog和当日信息流；不改历史正文，不将公众号转载、招聘重列和旧数据包装成已实施改革。
- PDF扫描与阅读分别记录；网页方法已核不等于报告PDF已逐页精读。

## [2026-09-14] ingest | 责任与负担检查卡、W37信息库双版本

- 新增一张比较知识卡，连接9月14日两篇旧研究与两条弱信号；不把旧线计新增，不提升匿名证据等级。
- 新增W37快速导读与详细周报的导航和catalog条目，聚合9月7—13日62条收录记录；专题与信息库分开治理。
- 更新index、catalog；PDF下载、阅读与沉淀分开记录，未改历史日报正文。

## [2026-09-13] ingest | 授权、监督与支持机制比较

- 新增一张机制比较页，连接当日原文与昨日工作分配知识卡；不把咨询建议、招聘意图或外部评估承诺写成已验证效果。
- 更新index与catalog；Oracle未取到原附注，候选金额不进入知识结论。
- PDF扫描、下载与阅读分别记录；本轮不改专题正文，不把知识目录刷新当作信息库交付。

## [2026-09-12] ingest | 工作分配与员工支持比较

- 新增机制比较卡，连接普信组织分工、NTEN与Bridgespan调查、Wipro人员转配和暴雪员工协商案例，保留原始日期与证据等级。
- 补LHH／PwC数字年代核验；未取得完整脚注，不将56%写成2026新测量。Moka与xAI只作L1问题入口。
- 更新catalog与index，连接昨日知识卡及员工风险概念；NTEN方法与关键图表已核，不宣称81页逐页精读。PDF下载状态由当日自动入库记录说明。

## [2026-09-11] ingest | AI工作支持与负担比较

- 新增比较知识卡，承接4条公告或报告新事实、2条旧研究、2条L1线索；所有事实通过当日信息卡追溯公开原文。
个已下载原始 PDF，11 个保留 URL 与引用上下文待重试。
- 已下载：itb dia 6351 email 0（引用 4 次）
- 已下载：itb lat dir ai 6454 web 0（引用 17 次）
...
- 已下载：20260828（引用 9 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-09-04] ingest | 当日组织机制回流
- 将 OpenAI Astra 的开发—发布—运行控制链和 Daybreak 的分布式交付责任回流 `knowledge/entities/openai.md` 与 `knowledge/concepts/capability-to-product-conversion-loop.md`。
- 将 Anthropic 在法律、商务与国防采购之间的外部信任边界回流 `knowledge/entities/anthropic.md`，不反推内部组织变化。
- 将英伟达／Hugging Face 的平台整合边界、Astra 的暂停恢复权和 Adobe 接班治理回流 `knowledge/concepts/ai-first-operating-model.md`，保留运行结果与员工收益边界。
- Kimi 匿名递表、具身智能招聘倍数、公众号缺口和 Zscaler 旧事件均未升级为知识库强结论。

## [2026-09-04] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
- 本次识别 70 个唯一 PDF 来源：59 个已下载原始 PDF，11 个保留 URL 与引用上下文待重试。
- 已下载：itb dia 6351 email 0（引用 4 次）
- 已下载：itb lat dir ai 6454 web 0（引用 17 次）
- 已下载：GoogleATLASv1（引用 7 次）
- 已下载：CWA18398 2026（引用 5 次）
...
- 已下载：20260828（引用 9 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-09-03] ingest | 当日组织机制回流
- 将微软“经营单元—管理单元—报告单元”同构证据回流 `knowledge/entities/microsoft.md` 与 `knowledge/concepts/ai-first-operating-model.md`，保留人员、预算、层级和后效边界。
- 将优步扁平化与减员的员工负荷、地域迁移和协调工作转移风险，以及 OpenAI 暂停治理的人工责任回流 `knowledge/concepts/ai-workforce-risk.md`；不把优步重组归因为 AI。
- 将中国前线部署工程的培养、政策、招聘和企业案例证据回流 `knowledge/concepts/fde-applied-ai.md`，继续区分前线宽责任与后台深专家。
- 本日没有把匿名社区、动态招聘页、兜底专题稿或缺口记录升级为强结论。

## [2026-09-03] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
- 本次识别 70 个唯一 PDF 来源：59 个已下载原始 PDF，11 个保留 URL 与引用上下文待重试。
- 已下载：itb dia 6351 email 0（引用 4 次）
- 已下载：itb lat dir ai 6454 web 0（引用 17 次）
...
- 已下载：20260828（引用 9 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-09-02] ingest | 当日组织机制回流
- 将 OpenAI Astra、Manus 监管拆分、Apple 接班治理与 Anthropic 企业安全责任链回流 `knowledge/concepts/ai-first-operating-model.md`。
- 将百度智能云、神策数据的前线部署工程案例回流 `knowledge/concepts/fde-applied-ai.md`，保留“宽责任接口＋深专家平台”的证据边界。
- 将可执行风险门槛、多方责任链及员工治理信任研究回流 `knowledge/concepts/ai-workforce-risk.md`；旧数据只作 Context，不重置为今日新增。
- 本日没有把兜底专题稿、动态招聘页或单一媒体线索升级为知识库强结论。

## [2026-09-02] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
- 本次识别 69 个唯一 PDF 来源：58 个已下载原始 PDF，11 个保留 URL 与引用上下文待重试。
- 已下载：itb dia 6351 email 0（引用 4 次）
- 已下载：itb lat dir ai 6454 web 0（引用 17 次）
- 已下载：GoogleATLASv1（引用 7 次）
- 已下载：CWA18398 2026（引用 5 次）
...
- 将 BCG 的端到端结果与净生产率框架回流 `knowledge/concepts/human-ai-performance-metrics.md`。

## [2026-09-01] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
- 本次识别 69 个唯一 PDF 来源：58 个已下载原始 PDF，11 个保留 URL 与引用上下文待重试。
- 已下载：itb dia 6351 email 0（引用 4 次）
- 已下载：itb lat dir ai 6454 web 0（引用 17 次）
...
- 已下载：2026 global ai jobs barometer global findings（引用 2 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-08-28] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
- 本次识别 68 个唯一 PDF 来源：57 个已下载原始 PDF，11 个保留 URL 与引用上下文待重试。
- 已下载：itb dia 6351 email 0（引用 4 次）
- 已下载：itb lat dir ai 6454 web 0（引用 17 次）
...
- 已下载：2026 global ai jobs barometer global findings（引用 2 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-08-27] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
- 本次识别 68 个唯一 PDF 来源：57 个已下载原始 PDF，11 个保留 URL 与引用上下文待重试。
- 已下载：itb dia 6351 email 0（引用 4 次）
- 已下载：itb lat dir ai 6454 web 0（引用 17 次）
...
- 已下载：2026 global ai jobs barometer global findings（引用 2 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-08-27] update | 运行许可、回撤闸门与外部质疑证据回流
- 更新 OpenAI、Anthropic 实体页，回流工作负载复启、多模态安全产品经理、法律行业 FDE 与受控外部研究接口。
- 更新“人—AI—人机系统三层绩效指标”与“能力—产品转换回路”概念页，补充 Meta 结构回撤、欧洲央行时间再配置和 MiniMax 评测底座证据。
- 所有判断回链 `digest.md` 2026-08-27 信息卡；没有把岗位、供应商声明或自报节时升级为组织运行结果。
...
- 已下载：2026 global ai jobs barometer global findings（引用 2 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-08-26] update | 当日高价值情报回流
- 更新 ByteDance 实体页：记录 TRAE、扣子与豆包组合收敛的窄口径组织结构证据，并保留效率结果边界。
- 更新 OpenAI、AWS / Amazon 实体页与 FDE / Applied AI 概念页：回流关键岗位连续性、亲自构建型管理和全员原型能力线索。
- 所有判断均回链 `digest.md` 2026-08-26 信息卡；没有把招聘信号或厂商声明升级为组织运行结果。

## [2026-08-25] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
...
- 已下载：2026 global ai jobs barometer global findings（引用 2 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-08-25] update | 当日高价值情报回流
- 更新 `knowledge/concepts/fde-applied-ai.md`：加入 Mistral AI × HUMAIN 的跨公司主权 AI 交付边界，并保留联合治理、服务水平、数据权利和客户结果缺口。
- 更新 `knowledge/concepts/ai-workforce-risk.md`：加入智能体支付公约、Google 动态权限和 Zywave 保险/初级人才管道线索，结论保持 L1-L2。
- 更新 `knowledge/concepts/end-to-end-journey-redesign.md`：加入 Notion 复合流程岗位、Culture Amp 人员数据工作流和 iManage 知识写回证据。
- 所有判断回链 `digest.md` 2026-08-25，未把招聘页面、供应商调查或会议议程升级为运行结果。
...
- 发现 W34 周报仍把 8 月 21 日写为 fallback，而当前 manifest/quality/status 已标 formal；列为 P1 状态一致性问题。
- 发现 55 张标准化 PDF 卡被归为 media，其中包含学术、政府、监管和公司一手材料；列为 P1 证据类型问题。
- 一方硬断链 0，公开根页、8 月 23 日和 8 月 24 日扫描页均返回 200；未发现私有路径或被排除来源泄露。
- 新增结构化巡检报告：`knowledge/wiki/local-knowledge-review-2026-08-24.md`。

## [2026-08-24] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
...
- 已下载：2026 global ai jobs barometer global findings（引用 2 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-08-23] ingest | OpenAI 治理前移与算力经济性接口回流
- 更新 `knowledge/entities/openai.md`，纳入 SB 53 强化主张、前沿实验室处置回应和 B2B 产品战略财务岗位。
- 更新 `knowledge/concepts/ai-workforce-risk.md`，纳入 Maxio 的人力扩张曲线、AI 权限差异与心理安全观察，并把匿名矛盾线索留在验证边界。
- 判断保持 L1-L2：公共政策立场和公司回应不等于内部否决权，岗位设计不等于组合损益权或运行结果。
- 所有判断回链 `digest.md` 2026-08-23 [D01]—[D06]，并新增修法文本、恢复签字链和资源配置决策权的待验证问题。

## [2026-08-22] ingest | 日报 PDF 证据源自动入库
- 从 daily、daily-report、specials、analysis 中扫描 PDF URL，按知识库 Raw/Wiki/Catalog 规则自动建档。
...
- 已下载：2026 global ai jobs barometer global findings（引用 2 次）
- 待重试：it job family career ladder matrix software engineer（引用 1 次）
## [2026-08-22] ingest | 实施责任包与伙伴基础设施边界回流
- 更新 `knowledge/concepts/end-to-end-journey-redesign.md`，加入 SAP 任务—技能—智能体分工和 ServiceNow 采用闭环，并明确智能体执行、人工复核、专业签字、例外判断四类责任。
- 更新 `knowledge/entities/anthropic.md`，记录共享需求编号不能直接换算编制，以及制造质量与伙伴站点运营责任向外部边界延伸。
- 所有判断回链 `digest.md` 2026-08-22 [D01]、[D05]、[D07]—[D08]；岗位证据保持 L1，未写成扩编或组织成效。
...
- 更新 `knowledge/index.md` 与 `knowledge/catalog.json`；未下载或公开任何私有来源。
