...
- 本次识别 48 个唯一 PDF 来源：36 个已下载原始 PDF，12 个保留 URL 与引用上下文待重试。
- 待重试：itb lat dir ai 6454 web 0（引用 1 次）
...
- 待重试：gov.uscourts.cand.474171.1.0（引用 2 次）
...
- 待重试：Whitepaper Impact of AI on U.S. Labor Market 2026 R2 1（引用 1 次）
