...
### [1] Anthropic 推出 `Claude Corps`：把 early-career AI fellows 批量送进组织
...
### [3] FT：部分大型雇主把 graduate recruitment 削减至多 40%
...
### [4] PwC 信号继续强化：AI 暴露型初级岗位更高频要求 senior-level skills
...
- **主导信号**：今天最重要的新变化，是 AI 时代组织开始把一部分执行和成长接口外部化。组织竞争正在从“内部岗位怎么改”升级到“哪些入口保留在内部、哪些交给 fellows / AI services / 外部供给、哪些必须重新制度化补回”。
- **最值得继续追踪的变量**：
  - fellowship / residency 是否会成为企业常规 AI 人才入口
  - graduate hiring 收缩后，内部 apprenticeship 机制如何补位
  - 哪些资源诉求应走 premium / allowance，而不是新增序列或直接晋升
