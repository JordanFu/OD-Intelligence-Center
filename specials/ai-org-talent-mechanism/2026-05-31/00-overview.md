# 2026-05-31｜AI时代组织与人才机制四课题日报

> 周末补跑 / 决策稿。本稿用于替换此前自动化占位内容；所有强判断只来自一手材料、权威咨询/媒体或已入库知识库的交叉验证。若证据不足，保留在 Context 或线索层，不冒充结论。
...
1. **执行层角色变宽的证据链增强（L3）**：BCG、Workday 与 Microsoft 都把 redesign 指向 tasks、handoffs、decision rights、authority boundary 与 team architecture，说明企业希望减少碎片化交接。
2. **核心专家角色深化也在增强（L3）**：McKinsey 的 AI-first technology workforce 要求企业明确哪些能力必须由员工建设；SAP/NVIDIA trusted runtime、Workday governance 都显示治理/架构/验证能力不会被简单合并掉。
3. **manager 的未来不是消失，而是 player-coach / orchestrator 化（L2）**：Workday 和 BCG 都把人机协作、authority boundary、governance 放入 manager/CHRO 议题，说明管理者的审批劳动会减少，但规则设定和例外处理责任会变厚。
4. **新建 job family 不是默认答案（L2）**：当新能力还只是横向技能时，应优先用 skill tag、项目激励、专项津贴或 market premium；只有 role package 稳定、交付物清晰、薪酬市场可验证时才考虑新建族群。
...
| 渠道 | 新增证据 | 可信度 |
|---|---|---|
| 官方/一手 | Workday human + agent operating model 强调 authority boundary、skills-based role redesign、outcome-based metrics 与员工透明感。（[来源](https://www.workday.com/en-us/perspectives/hr/operating-models-for-human-and-agents.html）） | L2-L3 |
| 权威媒体与案例 | McKinsey 强调 CIO/CEO/CHRO 需要回答哪些技术能力由员工建设、哪些由 agents 部署。（[来源](https://www.mckinsey.com/capabilities/mckinsey-technology/our-insights/designing-an-end-to-end-technology-workforce-for-the-ai-first-era）） | L2-L3 |
| 社媒/职场平台 | 弱信号仍是“AI 工具使个体产出倍增、小团队更能端到端交付”；暂不形成结论。 | L1 / 待验证 |
| 招聘薪酬 | AI governance、technical architect、FDE、agent operations 等角色需要继续追踪薪资区间和 level 边界。 | L1 / 待验证 |

## 5. 重点案例更新

### 中国公司

- 华为：AI 能力地图把业务、应用、模型、算力四层合并到一张图，说明中国公司也在从培训话术走向能力结构。

### 海外公司

- Workday：authority boundary 是人机团队的第一原则；McKinsey：核心技术能力不能全部交给 agents 或 vendor。
...
1. 哪些岗位只是技能标签，哪些已经形成稳定 role package？
2. manager 的 player-coach 化会提高人才密度，还是造成隐性加班与责任膨胀？
