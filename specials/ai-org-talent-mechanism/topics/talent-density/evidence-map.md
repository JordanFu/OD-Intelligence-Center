...
|---|---|---|---|---|---|---|---|
| 2026-06-30 | `specials/ai-org-talent-mechanism/2026-06-30/00-overview.md` | formal 总览判断 | 支持 H1、H2 | L3 | 机制 | 高密度人才要以业务判断、AI 编排、流程理解、风险意识和复用沉淀识别。 | 不能用工具活跃度替代绩效证据。 |
| 2026-06-28 | `specials/ai-org-talent-mechanism/2026-06-28/00-overview.md` | formal 总览判断 | 修正 H1 | L2-L3 | 观察 | AI 原生公司从小队进入平台化扩容时，组织问题转向标准、协调损耗和新人进入。 | DeepSeek 扩招证据仍需官方组织细节。 |
