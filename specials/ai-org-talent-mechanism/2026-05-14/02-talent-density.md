# 2026-05-14｜专题二：高人才密度与复合型人才机制（返工增强版）

## 1. 今日一句话结论

高人才密度正在从“多招高绩效个体”升级为“让少数能定义问题、编排 AI、驱动 workflow 重构、沉淀复用资产的人产生更大组织杠杆”。
...
**为什么重要**：真正稀缺的不是 prompt 技巧，而是能在复杂组织里把 AI 变成可靠生产系统的人。
...
**可信度**：高。McKinsey 明确连接技术组织和 workforce redesign。
...
- **McKinsey human-AI workforce 讨论提示**：AI 能承担大量工作时，人类价值更集中在判断、协作、例外处理和意义建构。

## 4. 人才密度新评价框架

| 维度 | 看什么 | 不看什么 |
|---|---|---|
| 问题定义 | 能否把模糊业务问题转成可执行 workflow | 不只看是否会写 prompt |
| AI 编排 | 能否让 agent、数据、系统、人协同 | 不只看用了几个工具 |
| 质量判断 | 能否识别 hallucination、风险和边界 | 不只看速度提升 |
| 组织推进 | 能否跨团队获得资源和改变流程 | 不只看个人产出 |
| 资产沉淀 | 能否形成模板、agent、流程、知识库 | 不只看一次性项目成功 |

## 5. 落地机制

1. 建立“AI workflow project”作为识别复合型人才的主战场。
2. 用项目 owner、acting role、内部 demo day 和业务复盘收集证据。
3. 对 AI 贡献做复用率、质量、风险下降、业务结果四类记录。
4. 保留初级人才入口，但把初级工作从重复执行改为 AI 辅助下的真实项目学习。
5. 让 manager 负责人才密度提升，而不是只要求员工自己学 AI。
