...
AI 可以标准化人才信息收集，但不能直接替代录用、晋升和潜力裁决；更可靠的方向是让机器改善证据结构，让人对标准、例外、公平和最终决定负责。
...
1. AI 可以标准化人才信息收集，但不能直接替代录用、晋升和潜力裁决；更可靠的方向是让机器改善证据结构，让人对标准、例外、公平和最终决定负责。
