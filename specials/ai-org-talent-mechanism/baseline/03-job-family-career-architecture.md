...
岗位体系的主线是“双向运动”：交付层岗位边界变宽、端到端责任增强；AI infra、eval、安全治理、数据治理、agent engineering 等核心专家能力继续深化并溢价。

## 稳定判断（高置信/可复用）

1. **岗位体系的主线是“双向运动”：交付层岗位边界变宽、端到端责任增强；AI infra…**  
   岗位体系的主线是“双向运动”：交付层岗位边界变宽、端到端责任增强；AI infra、eval、安全治理、数据治理、agent engineering 等核心专家能力继续深化并溢价。
2. **不应把所有新能力都固化为 job family。长期稳定、战略关键、可评价、可定价…**  
   不应把所有新能力都固化为 job family。长期稳定、战略关键、可评价、可定价的能力才适合新建岗位/族群/序列；短期热词优先用技能标签、项目角色或专项激励承接。
3. **业务提出新增族群/序列时，必须先识别真实诉求：如果本质是关键人才定价和保留，应优先…**  
   业务提出新增族群/序列时，必须先识别真实诉求：如果本质是关键人才定价和保留，应优先调整薪酬带宽、市场稀缺系数、项目激励或股权刷新，而不是制造 title inflation。

## 证据账本（自动从日报/周报抽取）

| 日期 | 入口 | 证据层级 | 可沉淀判断 | Context/弱信号 | 待验证 |
|---|---|---|---|---|---|
| 2026-05-13 | [日报](../2026-05-13/03-job-family-career-architecture.html) | Context层强证据 | 1. **岗位变宽主要发生在业务交付与管理协调层，而非所有领域。** 可信度：高。证据：Coinbase（one-person teams / player-coach）+ Block（IC/DRI/player-coach）+ Amazon Builder（titl… | 1. **国内大厂的“通道打通/职级重命名”是否会同步重写薪酬与晋升规则。** 目前公开信息多为媒体转述，缺少全员信全文与 HR FAQ，难以判断其对 job family、任职资格与薪酬带宽的真实影响。 | 1. 继续寻找百度全员信全文或 HR FAQ，确认套改规则、是否影响薪酬带宽、晋升标准和管理/专业通道映射。 |
| 2026-05-14 | [日报](../2026-05-14/03-job-family-career-architecture.html) | Context层强证据 | 当日未抽取到核心判断，保留源文档待人工复核。 | - **Deloitte 的反例**：很多企业还停留在 education/upskilling，不足以证明岗位族群已经系统性变化。 | 待下次日报/周报继续追踪。 |
| 2026-05-15 | [日报](../2026-05-15/03-job-family-career-architecture.html) | 线索层/待验证 | 当日未抽取到核心判断，保留源文档待人工复核。 | 暂无单独 Context 摘要。 | - 采集 AI governance/agent ops JD。 |
| 2026-05-16 | [日报](../2026-05-16/03-job-family-career-architecture.html) | 线索层/待验证 | 当日未抽取到核心判断，保留源文档待人工复核。 | 暂无单独 Context 摘要。 | - 采集 AI governance/agent ops JD。 |
| 2026-05-17 | [日报](../2026-05-17/03-job-family-career-architecture.html) | 线索层/待验证 | 当日未抽取到核心判断，保留源文档待人工复核。 | 暂无单独 Context 摘要。 | - 采集 AI governance/agent ops JD。 |
| 2026-05-18 | [日报](../2026-05-18/03-job-family-career-architecture.html) | 线索层/待验证 | 口径：本专题优先回答三个问题：岗位边界是否变宽？哪些能力更专业化并产生溢价？当业务要求“新建岗位/族群/序列”时，什么时候其实是在争取薪酬与激励空间？ | 口径：本专题优先回答三个问题：岗位边界是否变宽？哪些能力更专业化并产生溢价？当业务要求“新建岗位/族群/序列”时，什么时候其实是在争取薪酬与激励空间？ | 口径：本专题优先回答三个问题：岗位边界是否变宽？哪些能力更专业化并产生溢价？当业务要求“新建岗位/族群/序列”时，什么时候其实是在争取薪酬与激励空间？ |
| 2026-05-19 | [日报](../2026-05-19/03-job-family-career-architecture.html) | 线索层/待验证 | 口径：本专题优先回答三个问题：岗位边界是否变宽？哪些能力更专业化并产生溢价？当业务要求“新建岗位/族群/序列”时，什么时候其实是在争取薪酬与激励空间？ | 口径：本专题优先回答三个问题：岗位边界是否变宽？哪些能力更专业化并产生溢价？当业务要求“新建岗位/族群/序列”时，什么时候其实是在争取薪酬与激励空间？ | 口径：本专题优先回答三个问题：岗位边界是否变宽？哪些能力更专业化并产生溢价？当业务要求“新建岗位/族群/序列”时，什么时候其实是在争取薪酬与激励空间？ |
| 2026-05-20 | [日报](../2026-05-20/03-job-family-career-architecture.html) | Context层强证据 | 1. **AI operating model 正在从工具层走向组织层。** IBM、Microsoft、Deloitte、McKinsey 的材料共同指向 agent、人、数据、流程和治理的一体化重构。 | 暂无单独 Context 摘要。 | 待下次日报/周报继续追踪。 |
...
| 2026-05-24 | [日报](../2026-05-24/03-job-family-career-architecture.html) | 线索层/待验证 | 本专题延续滚动课题：持续验证“岗位边界变粗/更端到端”与“关键领域更专业化/高溢价”的双向运动；并输出“什么时候新建序列、什么时候只用技能标签、什么时候用薪酬工具承接”的方法论。 | 本专题延续滚动课题：持续验证“岗位边界变粗/更端到端”与“关键领域更专业化/高溢价”的双向运动；并输出“什么时候新建序列、什么时候只用技能标签、什么时候用薪酬工具承接”的方法论。 | 本专题延续滚动课题：持续验证“岗位边界变粗/更端到端”与“关键领域更专业化/高溢价”的双向运动；并输出“什么时候新建序列、什么时候只用技能标签、什么时候用薪酬工具承接”的方法论。 |
...
- 岗位 title 合并后，内部 level、pay band 和晋升证据是否仍清晰？
- 业务诉求到底是责任边界变化，还是薪酬/激励空间不足？

## 最近日报入口

- 最新日报：2026-05-24｜[打开专题日报](../2026-05-24/03-job-family-career-architecture.html)｜源文件：`specials/ai-org-talent-mechanism/2026-05-24/03-job-family-career-architecture.md`
