...
|---|---|---|---|---|---|
| 2026-05-13 | [日报](../2026-05-13/03-job-family-career-architecture.html) | 背景材料（Context）强证据 | 1. **岗位变宽主要发生在业务交付与管理协调层，而非所有领域。** 可信度：高。证据：Coinbase（one-person teams / player-coach）+ Block（IC/DRI/player-coach）+ Amazon Builder（titl… | 1. **国内大厂的“通道打通/职级重命名”是否会同步重写薪酬与晋升规则。** 目前公开信息多为媒体转述，缺少全员信全文与 HR FAQ，难以判断其对 岗位族群（job family）、任职资格与薪酬带宽的真实影响。 | 1. 继续寻找百度全员信全文或 HR FAQ，确认套改规则、是否影响薪酬带宽、晋升标准和管理/专业通道映射。 |
...
| 2026-05-26 | [日报](../2026-05-26/03-job-family-career-architecture.html) | 线索层/待验证 | 1. **“更少更宽 title”是趋势线索，但不能替代内部 level 和 pay band。可信度：中高。** Amazon builder 是典型线索；它最值得追踪的不是 title 本身，而是晋升、薪酬和外部市场识别如何处理。 | 3. **新增岗位族群前必须先做四问。可信度：高。** 是否长期稳定？是否战略关键？是否能评价？是否需要独立定价？若答案不全是“是”，优先用技能标签、项目角色、专项激励或薪酬带宽调整。 | 待下次日报/周报继续追踪。 |
...
- 最新日报：2026-05-26｜[打开专题日报](../2026-05-26/03-job-family-career-architecture.html)｜源文件：`specials/ai-org-talent-mechanism/2026-05-26/03-job-family-career-architecture.md`
